use super::test_utils::{
    e, inp, isomorphic_with_boundary, make_map, make_named_open_hypergraph,
    make_open_hypergraph_named, named_match_witness, out, w, NamedEdge, NamedOpenGraph, NamedWire,
    DELTA, MU, OBJ,
};
use crate::array::vec::VecKind;
use crate::strict::open_hypergraph::{
    apply_smc_rewrite, OpenHypergraph, SmcRewriteMatch, SmcRewriteMatchError, SmcRewriteRule,
    SmcRewriteRuleError,
};
